...
namespace AddressBook
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<JournalDbcontext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters()
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("NevineAhmed"))
                };
            });
        }
